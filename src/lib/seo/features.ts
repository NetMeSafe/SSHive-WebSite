...
export const FEATURE_SEO: Record<Feature, FeatureSEO> = {
  ssh: {
    ...
    relatedFeatures: ['sftp', 'telnet', 'serial', 'tunnels', 'mcp', 'snippets'],
  ...
  sftp: {
    ...
    relatedFeatures: ['ftp', 'ssh', 'tunnels'],
  ...
  vnc: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: {
          en: 'No. VNC is a Pro feature alongside RDP and tunnels. The Pro upgrade is a one-time $17.99 on the Mac App Store with lifetime updates.',
          fr: 'Non. VNC est une fonctionnalité Pro avec RDP et les tunnels. L\'upgrade Pro est un achat unique a 19,99 € sur le Mac App Store avec mises a jour a vie.',
        },
      },
      {
  ...
  tunnels: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: {
          en: 'Tunnels are a Pro feature. Free tier covers SSH terminal + SFTP. Pro ($17.99 one-time) unlocks tunnels, RDP, VNC, broadcast, and unlimited sessions.',
          fr: 'Les tunnels sont une fonctionnalité Pro. Le gratuit couvre terminal SSH + SFTP. Pro (19,99 € achat unique) debloque tunnels, RDP, VNC, broadcast et sessions illimitees.',
        },
      },
    ],
    relatedFeatures: ['ssh', 'sftp', 'telnet'],
  ...
  mcp: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: {
          en: 'Yes. MCP integration is included in the Pro upgrade ($17.99 one-time). Free tier focuses on SSH and SFTP for individual use.',
          fr: 'Oui. L\'intégration MCP est incluse dans l\'upgrade Pro (19,99 € achat unique). Le gratuit se concentre sur SSH et SFTP pour usage individuel.',
        },
      },
    ],
  ...
  broadcast: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: {
          en: 'Yes, broadcast is part of Pro along with RDP, VNC, tunnels, and unlimited sessions. $17.99 one-time on the Mac App Store.',
          fr: 'Oui, broadcast fait partie de Pro avec RDP, VNC, tunnels et sessions illimitees. 19,99 € achat unique sur le Mac App Store.',
        },
      },
    ],
  ...
  snippets: {
    ...
    relatedFeatures: ['serial', 'broadcast', 'ssh'],
