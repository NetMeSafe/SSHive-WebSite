...
export const IOS_PAGES: IosFeatureSEO[] = [
     ...
     ──────────────────────────────────────────────────────────────────── */
  {
    ...
    metaDescription: {
      ...
      fr: 'Terminal SSH xterm-256color complet sur iPhone et iPad. Cles Ed25519 et ECDSA avec passphrase, Trousseau Touch ID / Face ID, 8 themes et tunnels SSH. Gratuit pour commencer.',
    },
    h1: {
    ...
    hero: {
      ...
      fr: 'Terminal xterm-256color, cles Ed25519 avec passphrase, Trousseau Touch ID, tunnels, le workflow SSH complet, natif sur iOS et iPadOS.',
    },
    intro: {
    ...
    capabilities: [
      ...
      {
        title: { en: 'SSH keys & known hosts', fr: 'Cles SSH et known hosts' },
        body: {
          ...
          fr: 'Generez des paires de cles Ed25519 ou ECDSA directement sur l\'appareil, importez des cles existantes (avec ou sans passphrase), et copiez la cle publique a coller dans `authorized_keys`. Les empreintes des hotes sont verifiees et epinglees a la premiere connexion (known hosts), avec une alerte claire si la cle d\'un serveur change.',
        },
      },
    ],
    whyHeading: {
