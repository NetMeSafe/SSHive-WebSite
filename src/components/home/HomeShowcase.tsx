...
export function HomeShowcase() {
  ...
  const featureItems = [
    ...
    { key: 'ftp', icon: FolderUp, gradient: 'from-lime-500/20 to-green-500/20', href: '/features/ftp' as const },
    ...
    { key: 'serial', icon: Cable, gradient: 'from-orange-500/20 to-amber-500/20', href: '/features/serial' as const },
    { key: 'telnet', icon: SquareTerminal, gradient: 'from-slate-500/20 to-zinc-500/20', href: '/features/telnet' as const },
